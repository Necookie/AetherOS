...
export default function Taskbar() {
    ...
    return (
        <div
            className="os-panel-motion flex h-14 w-full max-w-4xl items-center justify-between rounded-xl px-3 text-[12px] shadow-2xl backdrop-blur"
            style={{
        ...
        >
            <div className="flex items-center space-x-1">
                <button className="os-hover-motion group rounded-lg p-2 transition-colors hover:bg-white/10">
