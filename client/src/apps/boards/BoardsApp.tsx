                ...
                <main className="flex min-h-0 flex-1 flex-col">
                    ...
                    <div className="grid min-h-0 flex-1 gap-3 p-3 xl:grid-cols-[minmax(0,1fr),18rem]">
                        <div className="min-h-0 space-y-3">
                            ...
                            <section ref={boardRef} tabIndex={-1} className="overflow-auto rounded-lg border border-white/10 bg-tile-1 p-3 outline-none focus:ring-2 focus:ring-[var(--os-accent)]">
                                ...
                                {board.columns.map((column, columnIndex) => (
                                    <Fragment key={column.id}>
                                        <div className="min-w-[18rem] flex-1 rounded-lg border border-white/10 bg-tile-2 p-2.5">
